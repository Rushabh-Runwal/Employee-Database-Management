...
public class ModifyEmployee1 implements ActionListener  {
        JFrame jf;
        JLabel l3,l1,l2;
        JButton jb1,jb2;
        JTextField jtf;
    public ModifyEmployee1() {
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == this.jb1){
            jf.setVisible(false);
            ModifyEmployee p1 = new ModifyEmployee(jtf.getText());
        }
    ...
    public static void main(String[] args) {
        ModifyEmployee1 obj = new ModifyEmployee1();
    }
